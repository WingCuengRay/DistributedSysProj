...
/**
* FEAPP/ArrayBooleanHelper.java .
* Generated by the IDL-to-Java compiler (portable), version "3.2"
* from /Users/Ling/Desktop/eclipse-workspace/FE_DRRS_Group/src/FE.idl
* Tuesday, November 28, 2017 5:21:42 PM EST
*/

abstract public class ArrayBooleanHelper
{
  private static String  _id = "IDL:FEAPP/ArrayBoolean:1.0";
  ...
  synchronized public static org.omg.CORBA.TypeCode type ()
  {
    if (__typeCode == null)
    {
      ...
      __typeCode = org.omg.CORBA.ORB.init ().create_alias_tc (FEAPP.ArrayBooleanHelper.id (), "ArrayBoolean", __typeCode);
    }
    return __typeCode;
  }
